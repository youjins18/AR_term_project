"""Pure conversions from a MuJoCo snapshot to public ROS messages."""
...
def make_chr_state(snapshot: PlantSnapshot, stamp) -> ChrState:
    ...
    message.base_pose.position.x, message.base_pose.position.y, message.base_pose.position.z = (
        snapshot.base_position)
    (message.base_pose.orientation.w, message.base_pose.orientation.x,
     message.base_pose.orientation.y, message.base_pose.orientation.z) = snapshot.base_quaternion
    (message.base_twist.linear.x, message.base_twist.linear.y,
     message.base_twist.linear.z) = snapshot.base_linear_velocity
    (message.base_twist.angular.x, message.base_twist.angular.y,
     message.base_twist.angular.z) = snapshot.base_angular_velocity
    ...
    (message.tcp_pose.orientation.w, message.tcp_pose.orientation.x,
     message.tcp_pose.orientation.y, message.tcp_pose.orientation.z) = snapshot.tcp_quaternion
    return message
